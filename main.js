...
let modeBoard = document.querySelector(".mode-board")
let buttonMove = document.querySelector(".mode-btn")
...
modeBoard.onclick =  () => {
    ...
    navbar.classList.toggle("night-box")
    modeBoard?.classList.toggle("mode-board-night")
...
if (localStorage.getItem("mode") == "dark") {
    ...
    navbar.classList.add("night-box")
    modeBoard?.classList.add("mode-board-night")
    ...
    navbar.classList.remove("night-box")
    modeBoard?.classList.remove("mode-board-night")
